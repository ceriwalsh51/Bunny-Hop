...
public class BunnyHead extends AbstractGameObject {
	...
	private final float         JUMP_TIME_MAX           = 0.2f;
	...
	public void init() {
		...
		terminalVelocity.set(3.0f, 8.0f);                     // Set physics values
	...
	public void setJumping(boolean jumpKeyPressed) {
		...
		case JUMP_RISING:                                   // Rising in the air
			if (!jumpKeyPressed)								//if !jumpKeyPressed - only lets player jump once throughout whole game
		...
		case JUMP_FALLING:  								// Falling down after jump
			...
			if(WorldController.flappy == true) {
				if(jumpKeyPressed){
					timeJumping = JUMP_TIME_OFFSET_FLYING;
					jumpState = JUMP_STATE.JUMP_RISING;
				}

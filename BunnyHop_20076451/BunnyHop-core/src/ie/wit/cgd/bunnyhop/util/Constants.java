...
public class Constants {
    ...
    public static final String LEVEL_04						= "levels/level_04.png";
    ...
    public static final float TIMER_DURATION				= 50;
    
    public static final float MIN_SCORE						= 325;
    
    public static final float TIME_DELAY_MESSAGE			= 5;
}